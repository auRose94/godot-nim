...
proc load_PackedColorArray_proc =
  ...
  PackedColorArray_set = interface_Variant_getPtrBuiltinMethod(variantType PackedColorArray, addr proc_name, 1350366223)
  ...
  PackedColorArray_appendArray = interface_Variant_getPtrBuiltinMethod(variantType PackedColorArray, addr proc_name, 537428395)
  ...
  PackedColorArray_insert = interface_Variant_getPtrBuiltinMethod(variantType PackedColorArray, addr proc_name, 11085009)
  proc_name = api.newStringName "fill"
  PackedColorArray_fill = interface_Variant_getPtrBuiltinMethod(variantType PackedColorArray, addr proc_name, 3761353134)
  ...
  PackedColorArray_has = interface_Variant_getPtrBuiltinMethod(variantType PackedColorArray, addr proc_name, 88913544)
  ...
  PackedColorArray_slice = interface_Variant_getPtrBuiltinMethod(variantType PackedColorArray, addr proc_name, 2942803855)
  ...
  PackedColorArray_bsearch = interface_Variant_getPtrBuiltinMethod(variantType PackedColorArray, addr proc_name, 735671678)
  proc_name = api.newStringName "duplicate"
  PackedColorArray_duplicate = interface_Variant_getPtrBuiltinMethod(variantType PackedColorArray, addr proc_name, 3186305013)
  proc_name = api.newStringName "find"
  PackedColorArray_find = interface_Variant_getPtrBuiltinMethod(variantType PackedColorArray, addr proc_name, 3091171314)
  proc_name = api.newStringName "rfind"
  PackedColorArray_rfind = interface_Variant_getPtrBuiltinMethod(variantType PackedColorArray, addr proc_name, 3091171314)
  proc_name = api.newStringName "count"
  PackedColorArray_count = interface_Variant_getPtrBuiltinMethod(variantType PackedColorArray, addr proc_name, 3956594488)
