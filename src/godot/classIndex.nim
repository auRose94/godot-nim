...
type NativeMenu* = ref object of Object
template Super*(_: typedesc[NativeMenu]): typedesc = Object
...
template Super*(_: typedesc[OpenXRExtensionWrapperExtension]): typedesc = Object
...
template Super*(_: typedesc[OpenXRInteractionProfileMetadata]): typedesc = Object
...
type RenderData* = ref object of Object
template Super*(_: typedesc[RenderData]): typedesc = Object
template EngineClass*(_: typedesc[RenderData]): typedesc = RenderData
type RenderSceneData* = ref object of Object
template Super*(_: typedesc[RenderSceneData]): typedesc = Object
...
type XRVRS* = ref object of Object
template Super*(_: typedesc[XRVRS]): typedesc = Object
...
template Super*(_: typedesc[AnimationMixer]): typedesc = Node
...
type StatusIndicator* = ref object of Node
template Super*(_: typedesc[StatusIndicator]): typedesc = Node
...
template Super*(_: typedesc[OpenXRAPIExtension]): typedesc = RefCounted
...
template Super*(_: typedesc[RenderSceneBuffers]): typedesc = RefCounted
...
template Super*(_: typedesc[RenderSceneBuffersConfiguration]): typedesc = RefCounted
...
type XRTracker* = ref object of RefCounted
template Super*(_: typedesc[XRTracker]): typedesc = RefCounted
...
type RenderDataExtension* = ref object of RenderData
template Super*(_: typedesc[RenderDataExtension]): typedesc = RenderData
template EngineClass*(_: typedesc[RenderDataExtension]): typedesc = RenderDataExtension
type RenderDataRD* = ref object of RenderData
template Super*(_: typedesc[RenderDataRD]): typedesc = RenderData
template EngineClass*(_: typedesc[RenderDataRD]): typedesc = RenderDataRD
type RenderSceneDataExtension* = ref object of RenderSceneData
template Super*(_: typedesc[RenderSceneDataExtension]): typedesc = RenderSceneData
template EngineClass*(_: typedesc[RenderSceneDataExtension]): typedesc = RenderSceneDataExtension
type RenderSceneDataRD* = ref object of RenderSceneData
template Super*(_: typedesc[RenderSceneDataRD]): typedesc = RenderSceneData
...
template Super*(_: typedesc[AnimationPlayer]): typedesc = AnimationMixer
template EngineClass*(_: typedesc[AnimationPlayer]): typedesc = AnimationPlayer
type AnimationTree* = ref object of AnimationMixer
template Super*(_: typedesc[AnimationTree]): typedesc = AnimationMixer
...
type OpenXRCompositionLayer* = ref object of Node3D
template Super*(_: typedesc[OpenXRCompositionLayer]): typedesc = Node3D
...
type SkeletonModifier3D* = ref object of Node3D
template Super*(_: typedesc[SkeletonModifier3D]): typedesc = Node3D
...
type XRFaceModifier3D* = ref object of Node3D
template Super*(_: typedesc[XRFaceModifier3D]): typedesc = Node3D
...
type AudioStreamPlaybackInteractive* = ref object of AudioStreamPlayback
template Super*(_: typedesc[AudioStreamPlaybackInteractive]): typedesc = AudioStreamPlayback
template EngineClass*(_: typedesc[AudioStreamPlaybackInteractive]): typedesc = AudioStreamPlaybackInteractive
type AudioStreamPlaybackPlaylist* = ref object of AudioStreamPlayback
template Super*(_: typedesc[AudioStreamPlaybackPlaylist]): typedesc = AudioStreamPlayback
...
type AudioStreamPlaybackSynchronized* = ref object of AudioStreamPlayback
template Super*(_: typedesc[AudioStreamPlaybackSynchronized]): typedesc = AudioStreamPlayback
...
type EditorSceneFormatImporterFBX2GLTF* = ref object of EditorSceneFormatImporter
template Super*(_: typedesc[EditorSceneFormatImporterFBX2GLTF]): typedesc = EditorSceneFormatImporter
...
type EditorSceneFormatImporterUFBX* = ref object of EditorSceneFormatImporter
template Super*(_: typedesc[EditorSceneFormatImporterUFBX]): typedesc = EditorSceneFormatImporter
...
template Super*(_: typedesc[RenderSceneBuffersExtension]): typedesc = RenderSceneBuffers
...
template Super*(_: typedesc[RenderSceneBuffersRD]): typedesc = RenderSceneBuffers
...
type Compositor* = ref object of Resource
template Super*(_: typedesc[Compositor]): typedesc = Resource
template EngineClass*(_: typedesc[Compositor]): typedesc = Compositor
type CompositorEffect* = ref object of Resource
template Super*(_: typedesc[CompositorEffect]): typedesc = Resource
...
template Super*(_: typedesc[NavigationMeshSourceGeometryData2D]): typedesc = Resource
...
template Super*(_: typedesc[ResourceImporterBMFont]): typedesc = ResourceImporter
...
template Super*(_: typedesc[ResourceImporterBitMap]): typedesc = ResourceImporter
...
template Super*(_: typedesc[ResourceImporterCSVTranslation]): typedesc = ResourceImporter
...
template Super*(_: typedesc[ResourceImporterDynamicFont]): typedesc = ResourceImporter
...
template Super*(_: typedesc[ResourceImporterImage]): typedesc = ResourceImporter
...
template Super*(_: typedesc[ResourceImporterImageFont]): typedesc = ResourceImporter
...
template Super*(_: typedesc[ResourceImporterLayeredTexture]): typedesc = ResourceImporter
...
template Super*(_: typedesc[ResourceImporterMP3]): typedesc = ResourceImporter
...
template Super*(_: typedesc[ResourceImporterOBJ]): typedesc = ResourceImporter
...
template Super*(_: typedesc[ResourceImporterOggVorbis]): typedesc = ResourceImporter
...
template Super*(_: typedesc[ResourceImporterScene]): typedesc = ResourceImporter
...
template Super*(_: typedesc[ResourceImporterShaderFile]): typedesc = ResourceImporter
...
template Super*(_: typedesc[ResourceImporterTexture]): typedesc = ResourceImporter
...
template Super*(_: typedesc[ResourceImporterTextureAtlas]): typedesc = ResourceImporter
...
template Super*(_: typedesc[ResourceImporterWAV]): typedesc = ResourceImporter
...
type XRFaceTracker* = ref object of XRTracker
template Super*(_: typedesc[XRFaceTracker]): typedesc = XRTracker
template EngineClass*(_: typedesc[XRFaceTracker]): typedesc = XRFaceTracker
type XRPositionalTracker* = ref object of XRTracker
template Super*(_: typedesc[XRPositionalTracker]): typedesc = XRTracker
...
type Parallax2D* = ref object of Node2D
template Super*(_: typedesc[Parallax2D]): typedesc = Node2D
...
type TileMapLayer* = ref object of Node2D
template Super*(_: typedesc[TileMapLayer]): typedesc = Node2D
...
type OpenXRCompositionLayerCylinder* = ref object of OpenXRCompositionLayer
template Super*(_: typedesc[OpenXRCompositionLayerCylinder]): typedesc = OpenXRCompositionLayer
template EngineClass*(_: typedesc[OpenXRCompositionLayerCylinder]): typedesc = OpenXRCompositionLayerCylinder
type OpenXRCompositionLayerEquirect* = ref object of OpenXRCompositionLayer
template Super*(_: typedesc[OpenXRCompositionLayerEquirect]): typedesc = OpenXRCompositionLayer
template EngineClass*(_: typedesc[OpenXRCompositionLayerEquirect]): typedesc = OpenXRCompositionLayerEquirect
type OpenXRCompositionLayerQuad* = ref object of OpenXRCompositionLayer
template Super*(_: typedesc[OpenXRCompositionLayerQuad]): typedesc = OpenXRCompositionLayer
template EngineClass*(_: typedesc[OpenXRCompositionLayerQuad]): typedesc = OpenXRCompositionLayerQuad
type PhysicalBoneSimulator3D* = ref object of SkeletonModifier3D
template Super*(_: typedesc[PhysicalBoneSimulator3D]): typedesc = SkeletonModifier3D
template EngineClass*(_: typedesc[PhysicalBoneSimulator3D]): typedesc = PhysicalBoneSimulator3D
type SkeletonIK3D* = ref object of SkeletonModifier3D
template Super*(_: typedesc[SkeletonIK3D]): typedesc = SkeletonModifier3D
template EngineClass*(_: typedesc[SkeletonIK3D]): typedesc = SkeletonIK3D
type XRBodyModifier3D* = ref object of SkeletonModifier3D
template Super*(_: typedesc[XRBodyModifier3D]): typedesc = SkeletonModifier3D
template EngineClass*(_: typedesc[XRBodyModifier3D]): typedesc = XRBodyModifier3D
type XRHandModifier3D* = ref object of SkeletonModifier3D
template Super*(_: typedesc[XRHandModifier3D]): typedesc = SkeletonModifier3D
...
type AudioEffectHardLimiter* = ref object of AudioEffect
template Super*(_: typedesc[AudioEffectHardLimiter]): typedesc = AudioEffect
...
type AudioStreamInteractive* = ref object of AudioStream
template Super*(_: typedesc[AudioStreamInteractive]): typedesc = AudioStream
...
type AudioStreamPlaylist* = ref object of AudioStream
template Super*(_: typedesc[AudioStreamPlaylist]): typedesc = AudioStream
...
type AudioStreamSynchronized* = ref object of AudioStream
template Super*(_: typedesc[AudioStreamSynchronized]): typedesc = AudioStream
...
type FBXDocument* = ref object of GLTFDocument
template Super*(_: typedesc[FBXDocument]): typedesc = GLTFDocument
...
type FBXState* = ref object of GLTFState
template Super*(_: typedesc[FBXState]): typedesc = GLTFState
...
type VisualShaderNodeReroute* = ref object of VisualShaderNode
template Super*(_: typedesc[VisualShaderNodeReroute]): typedesc = VisualShaderNode
...
template Super*(_: typedesc[VisualShaderNodeRotationByAxis]): typedesc = VisualShaderNode
...
template Super*(_: typedesc[VisualShaderNodeScreenNormalWorldSpace]): typedesc = VisualShaderNode
...
template Super*(_: typedesc[VisualShaderNodeWorldPositionFromDepth]): typedesc = VisualShaderNode
...
type XRBodyTracker* = ref object of XRPositionalTracker
template Super*(_: typedesc[XRBodyTracker]): typedesc = XRPositionalTracker
template EngineClass*(_: typedesc[XRBodyTracker]): typedesc = XRBodyTracker
type XRControllerTracker* = ref object of XRPositionalTracker
template Super*(_: typedesc[XRControllerTracker]): typedesc = XRPositionalTracker
template EngineClass*(_: typedesc[XRControllerTracker]): typedesc = XRControllerTracker
type XRHandTracker* = ref object of XRPositionalTracker
template Super*(_: typedesc[XRHandTracker]): typedesc = XRPositionalTracker
...
template Super*(_: typedesc[GraphElement]): typedesc = Container
...
template Super*(_: typedesc[Texture2DRD]): typedesc = Texture2D
...
template Super*(_: typedesc[Texture3DRD]): typedesc = Texture3D
...
template Super*(_: typedesc[TextureLayeredRD]): typedesc = TextureLayered
...
type VisualShaderNodeFrame* = ref object of VisualShaderNodeResizableBase
template Super*(_: typedesc[VisualShaderNodeFrame]): typedesc = VisualShaderNodeResizableBase
...
type GraphFrame* = ref object of GraphElement
template Super*(_: typedesc[GraphFrame]): typedesc = GraphElement
template EngineClass*(_: typedesc[GraphFrame]): typedesc = GraphFrame
type GraphNode* = ref object of GraphElement
template Super*(_: typedesc[GraphNode]): typedesc = GraphElement
...
template Super*(_: typedesc[Texture2DArrayRD]): typedesc = TextureLayeredRD
...
template Super*(_: typedesc[TextureCubemapArrayRD]): typedesc = TextureLayeredRD
...
template Super*(_: typedesc[TextureCubemapRD]): typedesc = TextureLayeredRD
