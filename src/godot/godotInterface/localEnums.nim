...
type DisplayServer_Feature* {.size: sizeof(cuint).} = enum
  featureSubwindows = 0
  featureTouchscreen = 1
  featureMouse = 2
  featureMouseWarp = 3
  featureClipboard = 4
  featureVirtualKeyboard = 5
  featureCursorShape = 6
  featureCustomCursorShape = 7
  featureNativeDialog = 8
  featureIme = 9
  featureWindowTransparency = 10
  featureHidpi = 11
  featureIcon = 12
  featureNativeIcon = 13
  featureOrientation = 14
  featureSwapBuffers = 15
  featureClipboardPrimary = 17
  featureTextToSpeech = 18
  featureExtendToTitle = 19
  featureScreenCapture = 20
  featureStatusIndicator = 21
  featureNativeHelp = 22
  featureNativeDialogInput = 23
  featureNativeDialogFile = 24
...
type DisplayServer_CursorShape* {.size: sizeof(cuint).} = enum
  ...
  cursorHelp = 16
  cursorMax = 17
type DisplayServer_FileDialogMode* {.size: sizeof(cuint).} = enum
...
type NativeMenu_Feature* {.size: sizeof(cuint).} = enum
  featureGlobalMenu = 0
  featurePopupMenu = 1
  featureOpenCloseCallback = 2
  featureHoverCallback = 3
  featureKeyCallback = 4
type NativeMenu_SystemMenus* {.size: sizeof(cuint).} = enum
  invalidMenuId = 0
  mainMenuId = 1
  applicationMenuId = 2
  windowMenuId = 3
...
type Node_PhysicsInterpolationMode* {.size: sizeof(cuint).} = enum
...
type Node_InternalMode* {.size: sizeof(cuint).} = enum
  ...
  internalModeFront = 1
  internalModeBack = 2
type Node_AutoTranslateMode* {.size: sizeof(cuint).} = enum
...
type PhysicsServer2D_PinJointFlag* {.size: sizeof(cuint).} = enum
...
type RenderingServer_ArrayFormat* {.size: sizeof(cuint).} = enum
  ...
  arrayFormatVertex = 1'i32 shl arrayVertex.int32,
  arrayFormatNormal = 1'i32 shl arrayNormal.int32,
  arrayFormatTangent = 1'i32 shl arrayTangent.int32,
  arrayFormatColor = 1'i32 shl arrayColor.int32,
  arrayFormatTexUv = 1'i32 shl arrayTexUv.int32,
  arrayFormatTexUv2 = 1'i32 shl arrayTexUv2.int32,
  arrayFormatCustom0 = 1'i32 shl arrayCustom0.int32,
  arrayFormatCustom1 = 1'i32 shl arrayCustom1.int32,
  arrayFormatCustom2 = 1'i32 shl arrayCustom2.int32,
  arrayFormatCustom3 = 1'i32 shl arrayCustom3.int32,
  arrayFormatBones = 1'i32 shl arrayBones.int32,
  arrayFormatWeights = 1'i32 shl arrayWeights.int32,
  arrayFormatIndex = 1'i32 shl arrayIndex.int32,

  arrayFlagUse2dVertices = 1 shl (arrayIndex.int32+1 + 0),
  arrayFlagUseDynamicUpdate = 1 shl (arrayIndex.int32+1 + 1),
  arrayFlagUse8BoneWeights = 1 shl (arrayIndex.int32+1 + 2),

  arrayFlagUsesEmptyVertexArray = 1 shl (arrayIndex.int32+1 + 3),

  arrayFlagCompressAttributes = 1 shl (arrayIndex.int32+1 + 4),
  arrayFlagFormatVersion2 = 1'u64 shl ((arrayIndex.int32 + 1 + 12)+10)
...
type RenderingServer_ViewportVRSMode* {.size: sizeof(cuint).} = enum
  ...
  viewportVrsXr = 2
  viewportVrsMax = 3
type RenderingServer_ViewportVRSUpdateMode* {.size: sizeof(cuint).} = enum
...
type RenderingServer_SkyMode* {.size: sizeof(cuint).} = enum
  ...
  skyModeRealtime = 3
type RenderingServer_CompositorEffectFlags* {.size: sizeof(cuint).} = enum
...
type RenderingServer_CompositorEffectCallbackType* {.size: sizeof(cuint).} = enum
...
type RenderingServer_EnvironmentFogMode* {.size: sizeof(cuint).} = enum
...
type ScriptLanguage_ScriptNameCasing* {.size: sizeof(cuint).} = enum
...
type AnimationMixer_AnimationCallbackModeProcess* {.size: sizeof(cuint).} = enum
  animationCallbackModeProcessPhysics = 0
  animationCallbackModeProcessIdle = 1
  animationCallbackModeProcessManual = 2
type AnimationMixer_AnimationCallbackModeMethod* {.size: sizeof(cuint).} = enum
  animationCallbackModeMethodDeferred = 0
  animationCallbackModeMethodImmediate = 1
type AnimationMixer_AnimationCallbackModeDiscrete* {.size: sizeof(cuint).} = enum
...
type Viewport_VRSMode* {.size: sizeof(cuint).} = enum
  ...
  vrsXr = 2
  vrsMax = 3
type Viewport_VRSUpdateMode* {.size: sizeof(cuint).} = enum
  vrsUpdateDisabled = 0
  vrsUpdateOnce = 1
  vrsUpdateAlways = 2
  vrsUpdateMax = 3
...
type AStarGrid2D_DiagonalMode* {.size: sizeof(cuint).} = enum
  ...
  diagonalModeMax = 4
type AStarGrid2D_CellShape* {.size: sizeof(cuint).} = enum
  cellShapeSquare = 0
...
type FileAccess_CompressionMode* {.size: sizeof(cuint).} = enum
  ...
  compressionGzip = 3
  compressionBrotli = 4
type FileAccess_UnixPermissionFlags* {.size: sizeof(cuint).} = enum
  unixExecuteOther = 0
  unixWriteOther = 1
  unixReadOther = 2
  unixExecuteGroup = 3
  ...
  unixSetGroupId = 10
  unixSetUserId = 11
  `--PADDING_MAX--` = 31 # To align size-of set[FileAccess_UnixPermissionFlags] to size-of cuint.
...
type OpenXRAPIExtension_OpenXRAlphaBlendModeSupport* {.size: sizeof(cuint).} = enum
...
type TextServer_FixedSizeScaleMode* {.size: sizeof(cuint).} = enum
...
type OpenXRHand_MotionRange* {.size: sizeof(cuint).} = enum
  ...
  motionRangeMax = 2
type OpenXRHand_SkeletonRig* {.size: sizeof(cuint).} = enum
  skeletonRigOpenxr = 0
  skeletonRigHumanoid = 1
  skeletonRigMax = 2
type OpenXRHand_BoneUpdate* {.size: sizeof(cuint).} = enum
  boneUpdateFull = 0
...
type Skeleton3D_ModifierCallbackModeProcess* {.size: sizeof(cuint).} = enum
...
type Window_ContentScaleStretch* {.size: sizeof(cuint).} = enum
...
type CompositorEffect_EffectCallbackType* {.size: sizeof(cuint).} = enum
...
type Environment_GlowBlendMode* {.size: sizeof(cuint).} = enum
  ...
  glowBlendModeMix = 4
type Environment_FogMode* {.size: sizeof(cuint).} = enum
...
type GLTFDocument_RootNodeMode* {.size: sizeof(cuint).} = enum
...
type NavigationPolygon_ParsedGeometryType* {.size: sizeof(cuint).} = enum
  parsedGeometryMeshInstances = 0
  parsedGeometryStaticColliders = 1
  parsedGeometryBoth = 2
  parsedGeometryMax = 3
type NavigationPolygon_SourceGeometryMode* {.size: sizeof(cuint).} = enum
  sourceGeometryRootNodeChildren = 0
  sourceGeometryGroupsWithChildren = 1
  sourceGeometryGroupsExplicit = 2
  sourceGeometryMax = 3
...
type SceneReplicationConfig_ReplicationMode* {.size: sizeof(cuint).} = enum
...
type OpenXRInterface_Hand* {.size: sizeof(cuint).} = enum
  handLeft = 0
  handRight = 1
  handMax = 2
type OpenXRInterface_HandMotionRange* {.size: sizeof(cuint).} = enum
  handMotionRangeUnobstructed = 0
  handMotionRangeConformToController = 1
  handMotionRangeMax = 2
type OpenXRInterface_HandTrackedSource* {.size: sizeof(cuint).} = enum
  handTrackedSourceUnknown = 0
  handTrackedSourceUnobstructed = 1
  handTrackedSourceController = 2
  handTrackedSourceMax = 3
type OpenXRInterface_HandJoints* {.size: sizeof(cuint).} = enum
  handJointPalm = 0
  handJointWrist = 1
  ...
  handJointMax = 26
type OpenXRInterface_HandJointFlags* {.size: sizeof(cuint).} = enum
  # handJointNone = 0
  ...
  `--PADDING_MAX--` = 31 # To align size-of set[OpenXRInterface_HandJointFlags] to size-of cuint.
...
type XRFaceTracker_BlendShapeEntry* {.size: sizeof(cuint).} = enum
  ftEyeLookOutRight = 0
  ftEyeLookInRight = 1
  ftEyeLookUpRight = 2
...
type GraphEdit_PanningScheme* {.size: sizeof(cuint).} = enum
  scrollZooms = 0
  scrollPans = 1
type GraphEdit_GridPattern* {.size: sizeof(cuint).} = enum
  gridPatternLines = 0
  gridPatternDots = 1
...
type RichTextLabel_MenuItems* {.size: sizeof(cuint).} = enum
  ...
  menuSelectAll = 1
  menuMax = 2
type RichTextLabel_MetaUnderline* {.size: sizeof(cuint).} = enum
  metaUnderlineNever = 0
  metaUnderlineAlways = 1
  metaUnderlineOnHover = 2
type RichTextLabel_ImageUpdateMask* {.size: sizeof(cuint).} = enum
  updateTexture = 0
  updateSize = 1
  updateColor = 2
  updateAlignment = 3
  ...
  `--PADDING_MAX--` = 31 # To align size-of set[RichTextLabel_ImageUpdateMask] to size-of cuint.
...
type TileMapLayer_DebugVisibilityMode* {.size: sizeof(cuint).} = enum
...
type XRBodyModifier3D_BodyUpdate* {.size: sizeof(cuint).} = enum
  bodyUpdateUpperBody = 0
  bodyUpdateLowerBody = 1
  bodyUpdateHands = 2
  `--PADDING_MAX--` = 31 # To align size-of set[XRBodyModifier3D_BodyUpdate] to size-of cuint.
type XRBodyModifier3D_BoneUpdate* {.size: sizeof(cuint).} = enum
  boneUpdateFull = 0
  boneUpdateRotationOnly = 1
  boneUpdateMax = 2

type XRHandModifier3D_BoneUpdate* {.size: sizeof(cuint).} = enum
  boneUpdateFull = 0
  boneUpdateRotationOnly = 1
  boneUpdateMax = 2
...
type AudioStreamInteractive_TransitionFromTime* {.size: sizeof(cuint).} = enum
  transitionFromTimeImmediate = 0
  transitionFromTimeNextBeat = 1
  transitionFromTimeNextBar = 2
  transitionFromTimeEnd = 3
type AudioStreamInteractive_TransitionToTime* {.size: sizeof(cuint).} = enum
  transitionToTimeSamePosition = 0
  transitionToTimeStart = 1
type AudioStreamInteractive_FadeMode* {.size: sizeof(cuint).} = enum
  fadeDisabled = 0
  fadeIn = 1
  fadeOut = 2
  fadeCross = 3
  fadeAutomatic = 4
type AudioStreamInteractive_AutoAdvanceMode* {.size: sizeof(cuint).} = enum
...
type TileSetAtlasSource_TileAnimationMode* {.size: sizeof(cuint).} = enum
...
type XRBodyTracker_BodyFlags* {.size: sizeof(cuint).} = enum
  bodyFlagUpperBodySupported = 0
  bodyFlagLowerBodySupported = 1
  bodyFlagHandsSupported = 2
  `--PADDING_MAX--` = 31 # To align size-of set[XRBodyTracker_BodyFlags] to size-of cuint.
type XRBodyTracker_Joint* {.size: sizeof(cuint).} = enum
  jointRoot = 0
  jointHips = 1
  jointSpine = 2
  jointChest = 3
  ...
  jointMax = 76
type XRBodyTracker_JointFlags* {.size: sizeof(cuint).} = enum
  jointFlagOrientationValid = 0
  jointFlagOrientationTracked = 1
  jointFlagPositionValid = 2
  jointFlagPositionTracked = 3
  `--PADDING_MAX--` = 31 # To align size-of set[XRBodyTracker_JointFlags] to size-of cuint.

type XRHandTracker_HandTrackingSource* {.size: sizeof(cuint).} = enum
  handTrackingSourceUnknown = 0
  handTrackingSourceUnobstructed = 1
  handTrackingSourceController = 2
  handTrackingSourceMax = 3
type XRHandTracker_HandJoint* {.size: sizeof(cuint).} = enum
  handJointPalm = 0
  handJointWrist = 1
  handJointThumbMetacarpal = 2
  ...
  handJointMax = 26
type XRHandTracker_HandJointFlags* {.size: sizeof(cuint).} = enum
  ...
  `--PADDING_MAX--` = 31 # To align size-of set[XRHandTracker_HandJointFlags] to size-of cuint.
...
type FlowContainer_AlignmentMode* {.size: sizeof(cuint).} = enum
  ...
  alignmentCenter = 1
  alignmentEnd = 2
type FlowContainer_LastWrapAlignmentMode* {.size: sizeof(cuint).} = enum
...
type TabContainer_TabPosition* {.size: sizeof(cuint).} = enum
  positionTop = 0
  positionBottom = 1
  positionMax = 2
