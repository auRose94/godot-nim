...
method onRegisterMetadata*(self: OpenXRExtensionWrapperExtension) {.base.} = (discard)
method onBeforeInstanceCreated*(self: OpenXRExtensionWrapperExtension) {.base.} = (discard)
method onInstanceCreated*(self: OpenXRExtensionWrapperExtension; instance: uint64) {.base.} = (discard)
method onInstanceDestroyed*(self: OpenXRExtensionWrapperExtension) {.base.} = (discard)
method onSessionCreated*(self: OpenXRExtensionWrapperExtension; session: uint64) {.base.} = (discard)
method onProcess*(self: OpenXRExtensionWrapperExtension) {.base.} = (discard)
method onPreRender*(self: OpenXRExtensionWrapperExtension) {.base.} = (discard)
method onMainSwapchainsCreated*(self: OpenXRExtensionWrapperExtension) {.base.} = (discard)
method onSessionDestroyed*(self: OpenXRExtensionWrapperExtension) {.base.} = (discard)
method onStateIdle*(self: OpenXRExtensionWrapperExtension) {.base.} = (discard)
method onStateReady*(self: OpenXRExtensionWrapperExtension) {.base.} = (discard)
method onStateSynchronized*(self: OpenXRExtensionWrapperExtension) {.base.} = (discard)
method onStateVisible*(self: OpenXRExtensionWrapperExtension) {.base.} = (discard)
method onStateFocused*(self: OpenXRExtensionWrapperExtension) {.base.} = (discard)
method onStateStopping*(self: OpenXRExtensionWrapperExtension) {.base.} = (discard)
method onStateLossPending*(self: OpenXRExtensionWrapperExtension) {.base.} = (discard)
method onStateExiting*(self: OpenXRExtensionWrapperExtension) {.base.} = (discard)
...
method onViewportCompositionLayerDestroyed*(self: OpenXRExtensionWrapperExtension; layer: pointer) {.base.} = (discard)
proc bind_virtuals*(S: typedesc[OpenXRExtensionWrapperExtension]; T: typedesc) =
  S.Super.bind_virtuals(T)
  let table = vmethods(T)
  table["_get_requested_extensions"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).getRequestedExtensions().encode(r_ret)
  table["_set_system_properties_and_get_next_pointer"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).setSystemPropertiesAndGetNextPointer(p_args[0].decode(pointer)).encode(r_ret)
  table["_set_instance_create_info_and_get_next_pointer"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).setInstanceCreateInfoAndGetNextPointer(p_args[0].decode(pointer)).encode(r_ret)
  table["_set_session_create_and_get_next_pointer"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).setSessionCreateAndGetNextPointer(p_args[0].decode(pointer)).encode(r_ret)
  table["_set_swapchain_create_info_and_get_next_pointer"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).setSwapchainCreateInfoAndGetNextPointer(p_args[0].decode(pointer)).encode(r_ret)
  table["_set_hand_joint_locations_and_get_next_pointer"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).setHandJointLocationsAndGetNextPointer(p_args[0].decode(int32), p_args[1].decode(pointer)).encode(r_ret)
  table["_get_composition_layer_count"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).getCompositionLayerCount().encode(r_ret)
  table["_get_composition_layer"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).getCompositionLayer(p_args[0].decode(int32)).encode(r_ret)
  table["_get_composition_layer_order"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).getCompositionLayerOrder(p_args[0].decode(int32)).encode(r_ret)
  table["_get_suggested_tracker_names"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).getSuggestedTrackerNames().encode(r_ret)
  table["_on_register_metadata"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onRegisterMetadata()
  table["_on_before_instance_created"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onBeforeInstanceCreated()
  table["_on_instance_created"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onInstanceCreated(p_args[0].decode(uint64))
  table["_on_instance_destroyed"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onInstanceDestroyed()
  table["_on_session_created"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onSessionCreated(p_args[0].decode(uint64))
  table["_on_process"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onProcess()
  table["_on_pre_render"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onPreRender()
  table["_on_main_swapchains_created"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onMainSwapchainsCreated()
  table["_on_session_destroyed"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onSessionDestroyed()
  table["_on_state_idle"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onStateIdle()
  table["_on_state_ready"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onStateReady()
  table["_on_state_synchronized"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onStateSynchronized()
  table["_on_state_visible"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onStateVisible()
  table["_on_state_focused"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onStateFocused()
  table["_on_state_stopping"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onStateStopping()
  table["_on_state_loss_pending"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onStateLossPending()
  table["_on_state_exiting"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onStateExiting()
  table["_on_event_polled"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onEventPolled(p_args[0].decode(pointer)).encode(r_ret)
  table["_set_viewport_composition_layer_and_get_next_pointer"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).setViewportCompositionLayerAndGetNextPointer(p_args[0].decode(pointer), p_args[1].decode(Dictionary), p_args[2].decode(pointer)).encode(r_ret)
  table["_get_viewport_composition_layer_extension_properties"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).getViewportCompositionLayerExtensionProperties().encode(r_ret)
  table["_get_viewport_composition_layer_extension_property_defaults"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).getViewportCompositionLayerExtensionPropertyDefaults().encode(r_ret)
  table["_on_viewport_composition_layer_destroyed"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[OpenXRExtensionWrapperExtension](p_instance).onViewportCompositionLayerDestroyed(p_args[0].decode(pointer))

method setVertex*(self: PhysicsServer3DRenderingServerHandler; vertexId: int32; vertex: Vector3) {.base.} = (discard)
method setNormal*(self: PhysicsServer3DRenderingServerHandler; vertexId: int32; normal: Vector3) {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[PhysicsServer3DRenderingServerHandler]; T: typedesc) =
  S.Super.bind_virtuals(T)
  let table = vmethods(T)
  table["_set_vertex"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[PhysicsServer3DRenderingServerHandler](p_instance).setVertex(p_args[0].decode(int32), p_args[1].decode(Vector3))
  table["_set_normal"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[PhysicsServer3DRenderingServerHandler](p_instance).setNormal(p_args[0].decode(int32), p_args[1].decode(Vector3))
...
method postProcessKeyValue*(self: AnimationMixer; animation: GD_ref[Animation]; track: int32; value: Variant; objectId: uint64; objectSubIdx: int32): Variant {.base.} = (discard)
proc bind_virtuals*(S: typedesc[AnimationMixer]; T: typedesc) =
  S.Super.bind_virtuals(T)
  let table = vmethods(T)
  table["_post_process_key_value"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[AnimationMixer](p_instance).postProcessKeyValue(p_args[0].decode(GD_ref[Animation]), p_args[1].decode(int32), p_args[2].decode(Variant), p_args[3].decode(uint64), p_args[4].decode(int32)).encode(r_ret)
...
proc bind_virtuals*(S: typedesc[EditorPlugin]; T: typedesc) =
  ...
  table["_get_unsaved_status"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorPlugin](p_instance).getUnsavedStatus(p_args[0].decode(String)).encode(r_ret)
...
method pinJointSetFlag*(self: PhysicsServer2DExtension; joint: RID; flag: PhysicsServer2D_PinJointFlag; enabled: Bool) {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[PhysicsServer2DExtension]; T: typedesc) =
  ...
  table["_pin_joint_set_flag"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[PhysicsServer2DExtension](p_instance).pinJointSetFlag(p_args[0].decode(RID), p_args[1].decode(PhysicsServer2D_PinJointFlag), p_args[2].decode(Bool))
  table["_pin_joint_get_flag"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[PhysicsServer2DExtension](p_instance).pinJointGetFlag(p_args[0].decode(RID), p_args[1].decode(PhysicsServer2D_PinJointFlag)).encode(r_ret)
...
method setParameter*(self: AudioStreamPlayback; name: StringName; value: Variant) {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[AudioStreamPlayback]; T: typedesc) =
  ...
  table["_set_parameter"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[AudioStreamPlayback](p_instance).setParameter(p_args[0].decode(StringName), p_args[1].decode(Variant))
  table["_get_parameter"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[AudioStreamPlayback](p_instance).getParameter(p_args[0].decode(StringName)).encode(r_ret)
...
method gotoScriptLine*(self: EditorDebuggerPlugin; script: GD_ref[Script]; line: int32) {.base.} = (discard)
method breakpointsClearedInTree*(self: EditorDebuggerPlugin) {.base.} = (discard)
method breakpointSetInTree*(self: EditorDebuggerPlugin; script: GD_ref[Script]; line: int32; enabled: Bool) {.base.} = (discard)
proc bind_virtuals*(S: typedesc[EditorDebuggerPlugin]; T: typedesc) =
  ...
  table["_goto_script_line"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorDebuggerPlugin](p_instance).gotoScriptLine(p_args[0].decode(GD_ref[Script]), p_args[1].decode(int32))
  table["_breakpoints_cleared_in_tree"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorDebuggerPlugin](p_instance).breakpointsClearedInTree()
  table["_breakpoint_set_in_tree"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorDebuggerPlugin](p_instance).breakpointSetInTree(p_args[0].decode(GD_ref[Script]), p_args[1].decode(int32), p_args[2].decode(Bool))
...
method getExportOptionsOverrides*(self: EditorExportPlugin; platform: GD_ref[EditorExportPlatform]): Dictionary {.base.} = (discard)
method shouldUpdateExportOptions*(self: EditorExportPlugin; platform: GD_ref[EditorExportPlatform]): Bool {.base.} = (discard)
method getExportOptionWarning*(self: EditorExportPlugin; platform: GD_ref[EditorExportPlatform]; option: String): String {.base.} = (discard)
...
method supportsPlatform*(self: EditorExportPlugin; platform: GD_ref[EditorExportPlatform]): Bool {.base.} = (discard)
method getAndroidDependencies*(self: EditorExportPlugin; platform: GD_ref[EditorExportPlatform]; debug: Bool): PackedStringArray {.base.} = (discard)
method getAndroidDependenciesMavenRepos*(self: EditorExportPlugin; platform: GD_ref[EditorExportPlatform]; debug: Bool): PackedStringArray {.base.} = (discard)
method getAndroidLibraries*(self: EditorExportPlugin; platform: GD_ref[EditorExportPlatform]; debug: Bool): PackedStringArray {.base.} = (discard)
method getAndroidManifestActivityElementContents*(self: EditorExportPlugin; platform: GD_ref[EditorExportPlatform]; debug: Bool): String {.base.} = (discard)
method getAndroidManifestApplicationElementContents*(self: EditorExportPlugin; platform: GD_ref[EditorExportPlatform]; debug: Bool): String {.base.} = (discard)
method getAndroidManifestElementContents*(self: EditorExportPlugin; platform: GD_ref[EditorExportPlatform]; debug: Bool): String {.base.} = (discard)
proc bind_virtuals*(S: typedesc[EditorExportPlugin]; T: typedesc) =
  ...
  table["_get_export_options_overrides"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorExportPlugin](p_instance).getExportOptionsOverrides(p_args[0].decode(GD_ref[EditorExportPlatform])).encode(r_ret)
  ...
  table["_get_export_option_warning"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorExportPlugin](p_instance).getExportOptionWarning(p_args[0].decode(GD_ref[EditorExportPlatform]), p_args[1].decode(String)).encode(r_ret)
  ...
  table["_supports_platform"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorExportPlugin](p_instance).supportsPlatform(p_args[0].decode(GD_ref[EditorExportPlatform])).encode(r_ret)
  table["_get_android_dependencies"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorExportPlugin](p_instance).getAndroidDependencies(p_args[0].decode(GD_ref[EditorExportPlatform]), p_args[1].decode(Bool)).encode(r_ret)
  table["_get_android_dependencies_maven_repos"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorExportPlugin](p_instance).getAndroidDependenciesMavenRepos(p_args[0].decode(GD_ref[EditorExportPlatform]), p_args[1].decode(Bool)).encode(r_ret)
  table["_get_android_libraries"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorExportPlugin](p_instance).getAndroidLibraries(p_args[0].decode(GD_ref[EditorExportPlatform]), p_args[1].decode(Bool)).encode(r_ret)
  table["_get_android_manifest_activity_element_contents"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorExportPlugin](p_instance).getAndroidManifestActivityElementContents(p_args[0].decode(GD_ref[EditorExportPlatform]), p_args[1].decode(Bool)).encode(r_ret)
  table["_get_android_manifest_application_element_contents"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorExportPlugin](p_instance).getAndroidManifestApplicationElementContents(p_args[0].decode(GD_ref[EditorExportPlatform]), p_args[1].decode(Bool)).encode(r_ret)
  table["_get_android_manifest_element_contents"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorExportPlugin](p_instance).getAndroidManifestElementContents(p_args[0].decode(GD_ref[EditorExportPlatform]), p_args[1].decode(Bool)).encode(r_ret)
...
method setupLocalToScene*(self: Resource) {.base.} = (discard)
proc bind_virtuals*(S: typedesc[Resource]; T: typedesc) =
  S.Super.bind_virtuals(T)
  let table = vmethods(T)
  table["_setup_local_to_scene"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Resource](p_instance).setupLocalToScene()
...
method getRenderSceneBuffers*(self: RenderDataExtension): GD_ref[RenderSceneBuffers] {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[RenderDataExtension]; T: typedesc) =
  S.Super.bind_virtuals(T)
  let table = vmethods(T)
  table["_get_render_scene_buffers"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[RenderDataExtension](p_instance).getRenderSceneBuffers().encode(r_ret)
  table["_get_render_scene_data"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[RenderDataExtension](p_instance).getRenderSceneData().encode(r_ret)
  table["_get_environment"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[RenderDataExtension](p_instance).getEnvironment().encode(r_ret)
  table["_get_camera_attributes"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[RenderDataExtension](p_instance).getCameraAttributes().encode(r_ret)
...
proc bind_virtuals*(S: typedesc[RenderSceneDataExtension]; T: typedesc) =
  S.Super.bind_virtuals(T)
  let table = vmethods(T)
  table["_get_cam_transform"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[RenderSceneDataExtension](p_instance).getCamTransform().encode(r_ret)
  table["_get_cam_projection"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[RenderSceneDataExtension](p_instance).getCamProjection().encode(r_ret)
  table["_get_view_count"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[RenderSceneDataExtension](p_instance).getViewCount().encode(r_ret)
  table["_get_view_eye_offset"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[RenderSceneDataExtension](p_instance).getViewEyeOffset(p_args[0].decode(uint32)).encode(r_ret)
  table["_get_view_projection"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[RenderSceneDataExtension](p_instance).getViewProjection(p_args[0].decode(uint32)).encode(r_ret)
  table["_get_uniform_buffer"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[RenderSceneDataExtension](p_instance).getUniformBuffer().encode(r_ret)
...
method profilingSetSaveNativeCalls*(self: ScriptLanguageExtension; enable: Bool) {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[ScriptLanguageExtension]; T: typedesc) =
  ...
  table["_get_doc_comment_delimiters"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[ScriptLanguageExtension](p_instance).getDocCommentDelimiters().encode(r_ret)
  ...
  table["_can_make_function"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[ScriptLanguageExtension](p_instance).canMakeFunction().encode(r_ret)
  ...
  table["_preferred_file_name_casing"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[ScriptLanguageExtension](p_instance).preferredFileNameCasing().encode(r_ret)
  ...
  table["_debug_get_stack_level_source"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[ScriptLanguageExtension](p_instance).debugGetStackLevelSource(p_args[0].decode(int32)).encode(r_ret)
  ...
  table["_profiling_set_save_native_calls"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[ScriptLanguageExtension](p_instance).profilingSetSaveNativeCalls(p_args[0].decode(Bool))
...
method inputEvent*(self: CollisionObject3D; camera: Camera3D; event: GD_ref[InputEvent]; eventPosition: Vector3; normal: Vector3; shapeIdx: int32) {.base.} = (discard)
...
method processModification*(self: SkeletonModifier3D) {.base.} = (discard)
proc bind_virtuals*(S: typedesc[SkeletonModifier3D]; T: typedesc) =
  S.Super.bind_virtuals(T)
  let table = vmethods(T)
  table["_process_modification"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[SkeletonModifier3D](p_instance).processModification()
...
proc bind_virtuals*(S: typedesc[Window]; T: typedesc) =
  S.Super.bind_virtuals(T)
  let table = vmethods(T)
  table["_get_contents_minimum_size"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[Window](p_instance).getContentsMinimumSize().encode(r_ret)
...
method beginHandleAction*(self: EditorNode3DGizmo; id: int32; secondary: Bool) {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[EditorNode3DGizmo]; T: typedesc) =
  ...
  table["_begin_handle_action"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorNode3DGizmo](p_instance).beginHandleAction(p_args[0].decode(int32), p_args[1].decode(Bool))
...
method configure*(self: RenderSceneBuffersExtension; config: GD_ref[RenderSceneBuffersConfiguration]) {.base.} = (discard)
method setFsrSharpness*(self: RenderSceneBuffersExtension; fsrSharpness: Float) {.base.} = (discard)
method setTextureMipmapBias*(self: RenderSceneBuffersExtension; textureMipmapBias: Float) {.base.} = (discard)
method setUseDebanding*(self: RenderSceneBuffersExtension; useDebanding: Bool) {.base.} = (discard)
proc bind_virtuals*(S: typedesc[RenderSceneBuffersExtension]; T: typedesc) =
  S.Super.bind_virtuals(T)
  let table = vmethods(T)
  table["_configure"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[RenderSceneBuffersExtension](p_instance).configure(p_args[0].decode(GD_ref[RenderSceneBuffersConfiguration]))
  table["_set_fsr_sharpness"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[RenderSceneBuffersExtension](p_instance).setFsrSharpness(p_args[0].decode(Float))
  table["_set_texture_mipmap_bias"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[RenderSceneBuffersExtension](p_instance).setTextureMipmapBias(p_args[0].decode(Float))
  table["_set_use_debanding"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[RenderSceneBuffersExtension](p_instance).setUseDebanding(p_args[0].decode(Bool))
...
proc bind_virtuals*(S: typedesc[AudioStream]; T: typedesc) =
  ...
  table["_get_parameter_list"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[AudioStream](p_instance).getParameterList().encode(r_ret)

method renderCallback*(self: CompositorEffect; effectCallbackType: int32; renderData: RenderData) {.base.} = (discard)
proc bind_virtuals*(S: typedesc[CompositorEffect]; T: typedesc) =
  S.Super.bind_virtuals(T)
  let table = vmethods(T)
  table["_render_callback"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[CompositorEffect](p_instance).renderCallback(p_args[0].decode(int32), p_args[1].decode(RenderData))
...
method beginHandleAction*(self: EditorNode3DGizmoPlugin; gizmo: GD_ref[EditorNode3DGizmo]; handleId: int32; secondary: Bool) {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[EditorNode3DGizmoPlugin]; T: typedesc) =
  ...
  table["_begin_handle_action"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorNode3DGizmoPlugin](p_instance).beginHandleAction(p_args[0].decode(GD_ref[EditorNode3DGizmo]), p_args[1].decode(int32), p_args[2].decode(Bool))
...
method exportPreserialize*(self: GLTFDocumentExtension; state: GD_ref[GLTFState]): Error {.base.} = (discard)
method getSaveableImageFormats*(self: GLTFDocumentExtension): PackedStringArray {.base.} = (discard)
method serializeImageToBytes*(self: GLTFDocumentExtension; state: GD_ref[GLTFState]; image: GD_ref[Image]; imageDict: Dictionary; imageFormat: String; lossyQuality: Float): PackedByteArray {.base.} = (discard)
method saveImageAtPath*(self: GLTFDocumentExtension; state: GD_ref[GLTFState]; image: GD_ref[Image]; filePath: String; imageFormat: String; lossyQuality: Float): Error {.base.} = (discard)
method serializeTextureJson*(self: GLTFDocumentExtension; state: GD_ref[GLTFState]; textureJson: Dictionary; gltfTexture: GD_ref[GLTFTexture]; imageFormat: String): Error {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[GLTFDocumentExtension]; T: typedesc) =
  ...
  table["_get_image_file_extension"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[GLTFDocumentExtension](p_instance).getImageFileExtension().encode(r_ret)
  ...
  table["_export_preserialize"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[GLTFDocumentExtension](p_instance).exportPreserialize(p_args[0].decode(GD_ref[GLTFState])).encode(r_ret)
  table["_get_saveable_image_formats"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[GLTFDocumentExtension](p_instance).getSaveableImageFormats().encode(r_ret)
  table["_serialize_image_to_bytes"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[GLTFDocumentExtension](p_instance).serializeImageToBytes(p_args[0].decode(GD_ref[GLTFState]), p_args[1].decode(GD_ref[Image]), p_args[2].decode(Dictionary), p_args[3].decode(String), p_args[4].decode(Float)).encode(r_ret)
  table["_save_image_at_path"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[GLTFDocumentExtension](p_instance).saveImageAtPath(p_args[0].decode(GD_ref[GLTFState]), p_args[1].decode(GD_ref[Image]), p_args[2].decode(String), p_args[3].decode(String), p_args[4].decode(Float)).encode(r_ret)
  table["_serialize_texture_json"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[GLTFDocumentExtension](p_instance).serializeTextureJson(p_args[0].decode(GD_ref[GLTFState]), p_args[1].decode(Dictionary), p_args[2].decode(GD_ref[GLTFTexture]), p_args[3].decode(String)).encode(r_ret)
...
proc bind_virtuals*(S: typedesc[EditorImportPlugin]; T: typedesc) =
  ...
  table["_can_import_threaded"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[EditorImportPlugin](p_instance).canImportThreaded().encode(r_ret)
...
method fontSetDisableEmbeddedBitmaps*(self: TextServerExtension; fontRid: RID; disableEmbeddedBitmaps: Bool) {.base.} = (discard)
...
method fontSetFixedSizeScaleMode*(self: TextServerExtension; fontRid: RID; fixedSizeScaleMode: TextServer_FixedSizeScaleMode) {.base.} = (discard)
...
method fontSetSpacing*(self: TextServerExtension; fontRid: RID; spacing: TextServer_SpacingType; value: int64) {.base.} = (discard)
method fontGetSpacing*(self: TextServerExtension; fontRid: RID; spacing: TextServer_SpacingType): int64 {.base.} = (discard)
method fontSetBaselineOffset*(self: TextServerExtension; fontRid: RID; baselineOffset: float64) {.base.} = (discard)
...
method shapedTextSetCustomEllipsis*(self: TextServerExtension; shaped: RID; char: int64) {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[TextServerExtension]; T: typedesc) =
  ...
  table["_create_font_linked_variation"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).createFontLinkedVariation(p_args[0].decode(RID)).encode(r_ret)
  ...
  table["_font_set_disable_embedded_bitmaps"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).fontSetDisableEmbeddedBitmaps(p_args[0].decode(RID), p_args[1].decode(Bool))
  table["_font_get_disable_embedded_bitmaps"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).fontGetDisableEmbeddedBitmaps(p_args[0].decode(RID)).encode(r_ret)
  ...
  table["_font_set_fixed_size_scale_mode"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).fontSetFixedSizeScaleMode(p_args[0].decode(RID), p_args[1].decode(TextServer_FixedSizeScaleMode))
  table["_font_get_fixed_size_scale_mode"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).fontGetFixedSizeScaleMode(p_args[0].decode(RID)).encode(r_ret)
  ...
  table["_font_set_spacing"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).fontSetSpacing(p_args[0].decode(RID), p_args[1].decode(TextServer_SpacingType), p_args[2].decode(int64))
  table["_font_get_spacing"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).fontGetSpacing(p_args[0].decode(RID), p_args[1].decode(TextServer_SpacingType)).encode(r_ret)
  table["_font_set_baseline_offset"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).fontSetBaselineOffset(p_args[0].decode(RID), p_args[1].decode(float64))
  table["_font_get_baseline_offset"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).fontGetBaselineOffset(p_args[0].decode(RID)).encode(r_ret)
  ...
  table["_shaped_text_set_custom_ellipsis"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).shapedTextSetCustomEllipsis(p_args[0].decode(RID), p_args[1].decode(int64))
  table["_shaped_text_get_custom_ellipsis"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).shapedTextGetCustomEllipsis(p_args[0].decode(RID)).encode(r_ret)
  ...
  table["_shaped_text_get_word_breaks"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).shapedTextGetWordBreaks(p_args[0].decode(RID), p_args[1].decode(set[TextServer_GraphemeFlag]), p_args[2].decode(set[TextServer_GraphemeFlag])).encode(r_ret)
  ...
  table["_shaped_text_get_object_range"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).shapedTextGetObjectRange(p_args[0].decode(RID), p_args[1].decode(Variant)).encode(r_ret)
  table["_shaped_text_get_object_glyph"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).shapedTextGetObjectGlyph(p_args[0].decode(RID), p_args[1].decode(Variant)).encode(r_ret)
  ...
  table["_shaped_text_get_character_breaks"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).shapedTextGetCharacterBreaks(p_args[0].decode(RID)).encode(r_ret)
  table["_shaped_text_next_character_pos"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).shapedTextNextCharacterPos(p_args[0].decode(RID), p_args[1].decode(int64)).encode(r_ret)
  table["_shaped_text_prev_character_pos"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).shapedTextPrevCharacterPos(p_args[0].decode(RID), p_args[1].decode(int64)).encode(r_ret)
  table["_shaped_text_closest_character_pos"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).shapedTextClosestCharacterPos(p_args[0].decode(RID), p_args[1].decode(int64)).encode(r_ret)
  ...
  table["_is_valid_letter"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).isValidLetter(p_args[0].decode(uint64)).encode(r_ret)
  ...
  table["_string_get_character_breaks"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).stringGetCharacterBreaks(p_args[0].decode(String), p_args[1].decode(String)).encode(r_ret)
  ...
  table["_string_to_title"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TextServerExtension](p_instance).stringToTitle(p_args[0].decode(String), p_args[1].decode(String)).encode(r_ret)
...
method toggled*(self: BaseButton; toggledOn: Bool) {.base.} = (discard)
...
method tileDataRuntimeUpdate*(self: TileMapLayer; coords: Vector2i; tileData: TileData) {.base.} = (discard)
proc bind_virtuals*(S: typedesc[TileMapLayer]; T: typedesc) =
  S.Super.bind_virtuals(T)
  let table = vmethods(T)
  table["_use_tile_data_runtime_update"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TileMapLayer](p_instance).useTileDataRuntimeUpdate(p_args[0].decode(Vector2i)).encode(r_ret)
  table["_tile_data_runtime_update"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[TileMapLayer](p_instance).tileDataRuntimeUpdate(p_args[0].decode(Vector2i), p_args[1].decode(TileData))
...
method instanceCreate3*(self: ScriptExtension; forObject: Object): pointer {.base.} = (discard)
...
proc bind_virtuals*(S: typedesc[ScriptExtension]; T: typedesc) =
  ...
  table["_instance_create"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[ScriptExtension](p_instance).instanceCreate3(p_args[0].decode(Object)).encode(r_ret)
  ...
  table["_get_class_icon_path"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[ScriptExtension](p_instance).getClassIconPath().encode(r_ret)
  ...
  table["_has_static_method"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[ScriptExtension](p_instance).hasStaticMethod(p_args[0].decode(StringName)).encode(r_ret)
  table["_get_script_method_argument_count"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[ScriptExtension](p_instance).getScriptMethodArgumentCount(p_args[0].decode(StringName)).encode(r_ret)
  ...
  table["_is_abstract"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[ScriptExtension](p_instance).isAbstract().encode(r_ret)
...
proc bind_virtuals*(S: typedesc[VisualShaderNodeCustom]; T: typedesc) =
  ...
  table["_get_input_port_default_value"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[VisualShaderNodeCustom](p_instance).getInputPortDefaultValue(p_args[0].decode(int32)).encode(r_ret)
  table["_get_default_input_port"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[VisualShaderNodeCustom](p_instance).getDefaultInputPort(p_args[0].decode(VisualShaderNode_PortType)).encode(r_ret)
  ...
  table["_get_property_count"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[VisualShaderNodeCustom](p_instance).getPropertyCount().encode(r_ret)
  table["_get_property_name"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[VisualShaderNodeCustom](p_instance).getPropertyName(p_args[0].decode(int32)).encode(r_ret)
  table["_get_property_default_index"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[VisualShaderNodeCustom](p_instance).getPropertyDefaultIndex(p_args[0].decode(int32)).encode(r_ret)
  table["_get_property_options"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[VisualShaderNodeCustom](p_instance).getPropertyOptions(p_args[0].decode(int32)).encode(r_ret)
...
method propagateInputEvent*(self: SubViewportContainer; event: GD_ref[InputEvent]): Bool {.base.} = (discard)
proc bind_virtuals*(S: typedesc[SubViewportContainer]; T: typedesc) =
  S.Super.bind_virtuals(T)
  let table = vmethods(T)
  table["_propagate_input_event"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[SubViewportContainer](p_instance).propagateInputEvent(p_args[0].decode(GD_ref[InputEvent])).encode(r_ret)
...
method drawPort*(self: GraphNode; slotIndex: int32; position: Vector2i; left: Bool; color: Color) {.base.} = (discard)
proc bind_virtuals*(S: typedesc[GraphNode]; T: typedesc) =
  S.Super.bind_virtuals(T)
  let table = vmethods(T)
  table["_draw_port"] = proc(p_instance: ClassInstancePtr; p_args: UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} = cast[GraphNode](p_instance).drawPort(p_args[0].decode(int32), p_args[1].decode(Vector2i), p_args[2].decode(Bool), p_args[3].decode(Color))
